...
class TopCard extends StatelessWidget {
  ...
  const TopCard({super.key, required this.menuClicked, required this.defaultWidth, required this.dynamicWidth, required this.defaultHeight, required this.dynamicHeight, required this.colors});
